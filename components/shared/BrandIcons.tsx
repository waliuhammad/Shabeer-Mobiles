 ...
 * Social brand marks.
 *
 * lucide-react v1 removed brand logos (Facebook, Instagram, WhatsApp) for
 * trademark reasons, so these few are defined here as plain inline SVG.
 * They take the same props as a Lucide icon - className controls size and
 * currentColor controls the fill - so they drop into the same markup.
 *
 * Everything that is NOT a brand logo still comes from lucide-react.
 */
