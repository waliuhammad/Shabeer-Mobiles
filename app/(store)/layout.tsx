 ...
 *
 * The public pages here are the front page, about, contact, login and
 * register. STORE_NAV drops the shop-only links while the business does
 * not sell online, so the header never points at a 404.
 */
